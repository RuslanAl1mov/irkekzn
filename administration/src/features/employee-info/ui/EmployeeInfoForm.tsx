import cls from "./EmployeeInfoForm.module.css";
...
import { useEmployeeInfoStore } from "../model/store";
import { formatPhoneNumber } from "@/shared/lib/formater/";
import { Modal } from "@/shared/ui/modal";


export const EmployeeInfoForm = (): JSX.Element | null => {
    const { isOpen, user, close } = useEmployeeInfoStore();
