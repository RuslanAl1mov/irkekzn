...
const DEFAULT_SETTINGS: ISettingsPayload = {
    set_custom_product_settings: false,
...
const toSettingsPayload = (settings: ISettings | ISettingsPayload): ISettingsPayload => ({
    set_custom_product_settings: settings.set_custom_product_settings,
    is_all_colors_same_name: settings.is_all_colors_same_name,
    is_all_colors_same_price: settings.is_all_colors_same_price,
    is_all_colors_same_description: settings.is_all_colors_same_description,
    is_all_colors_same_model: settings.is_all_colors_same_model,
});
                            ...
                            <div className={cls.settingsContentBlock}>
                                <div className={cls.settingsRow}>
                                    <Switch
                                        ...
                                        value={settings.set_custom_product_settings}
                                        setValue={(value) => updateSetting("set_custom_product_settings", value)}
                                        disabled={isLoading}
                                    />
                                </div>
                                <div
                                    className={cn(
                                        ...
                                        { [cls.settingsSubRow__disabled]: isLoading || !settings.set_custom_product_settings },
                                    )}
                                >
                                    <Switch
                                        label="Все модификации товаров имеют одинаковое название"
                                        value={settings.is_all_colors_same_name}
                                        setValue={(value) => updateSetting("is_all_colors_same_name", value)}
                                        disabled={isLoading || !settings.set_custom_product_settings}
                                    />
                                </div>
                                <div
                                    className={cn(
                                ...
                                >
                                    <Switch
                                        ...
                                        value={settings.is_all_colors_same_price}
                                        setValue={(value) => updateSetting("is_all_colors_same_price", value)}
                                        disabled={isLoading || !settings.set_custom_product_settings}
                                    />
                                </div>
                                <div
                                ...
                                >
                                    <Switch
                                        ...
                                        value={settings.is_all_colors_same_description}
                                        setValue={(value) => updateSetting("is_all_colors_same_description", value)}
                                        disabled={isLoading || !settings.set_custom_product_settings}
                                    />
                                </div>
                                <div
                                ...
                                >
                                    <Switch
                                        ...
                                        value={settings.is_all_colors_same_model}
                                        setValue={(value) => updateSetting("is_all_colors_same_model", value)}
                                        disabled={isLoading || !settings.set_custom_product_settings}
                                    />
                                </div>
                            </div>
