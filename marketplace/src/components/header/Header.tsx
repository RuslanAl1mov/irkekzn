    ...
    return (
        <header className={style.header}>
            <div className={style.headerBlock}>
                ...
                {/* content */}
                <div className={style.headerContentBlock}>
                        ...
                        <ul className={style.headerContentList}>
                            ...
                            <li>
                                <div className={style.contentContainer} onMouseEnter={() => handleMouseEnter(0)}>
                                    ...
                                    <Box className={style.contentLableIconBlock}>
                                        ...
                                        <div className={style.popupHeaderMenuBlock}>
                                            <div className={style.menuCatalogBlock}>
                                                ...
                                                <ul className={style.menuCatalogList}>
                                                    <li><a className={style.menuCatalogLink} href="/">Смотреть все</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">NEW</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Платья</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Рубашки и блузы</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Футболки и майки</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Топы</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Брюки</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Юбки</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Шорты</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Жакеты и жилеты</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Куртки и бомберы</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Кардиганы и жилеты</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Пальто и плащи</a></li>
                                                </ul>

                                                {/* Второй столбец */}
                                                <ul className={style.menuCatalogList}>
                                                    <li><a className={style.menuCatalogLink} href="/">Вязаные изделия и трикотаж</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Бесшовный базовый трикотаж</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Премиальный трикотаж</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Sale</a></li>
                                                </ul>
                                        ...
                                        <div className={style.popupHeaderMenuBlock}>
                                            <div className={style.menuCatalogBlock}>
                                                ...
                                                <ul className={style.menuCatalogList}>
                                                    <li><a className={style.menuCatalogLink} href="/">Смотреть все</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">NEW</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Украшения</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Парфюмерия</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Платки и палантины</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Шарфы и снуды</a></li>
                                                </ul>

                                                {/* Второй столбец */}
                                                <ul className={style.menuCatalogList}>

                                                    <li><a className={style.menuCatalogLink} href="/">Ремни и пояса</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Головные уборы</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Sale</a></li>
                                                </ul>
                            ...
                            <li>
                                <div className={style.contentContainer}>
                                    ...
                                    <div className={style.popupHeaderMenuSmall}>
                                        <div className={style.popupHeaderMenuBlockSmall}>
                                            <div className={style.menuCatalogBlock}>
                                                {/* Первый столбец */}
                                                <ul className={style.menuCatalogList}>
                                                    <li><a className={style.menuCatalogLink} href="/">Бутики</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Связаться с нами</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Оплата и доставка</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Система скидок</a></li>
                                                    <li><a className={style.menuCatalogLink} href="/">Политика конфиденциальности</a></li>
                                                </ul>
